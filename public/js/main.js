(function () {
      ...
      w.ajaxSetup({
        ...
        setOffset: function (e, t, n) {
          var r,
            ...
            f = w(e),
            p = {};
          "static" === c && (e.style.position = "relative"), s = f.offset(), o = w.css(e, "top"), u = w.css(e, "left"), (("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1) ? (a = (r = f.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), g(t) && (t = t.call(e, n, w.extend({}, s))), null != t.top && (p.top = t.top - s.top + a), null != t.left && (p.left = t.left - s.left + i), "using" in t ? t.using.call(e, p) : f.css(p);
        }
      }, w.fn.extend({
        offset: function (e) {
    ...
    $(document).ready(function () {
      ...
      toggleButton.on("click", function () {
        ...
        if (toggleButton.text() == "Hide") toggleButton.text("show");else toggleButton.text("Hide");
      });
      ...
      function displayResults(results) {
        ...
        $.each(results, function (i, item) {
          var newResult = $("<div class='result'>" + "<div class='title'>" + item.name + "</div>" + "<div class='language'>" + item.language + "</div>" + "<div class='score'>" + item.owner.login + "</div>");
